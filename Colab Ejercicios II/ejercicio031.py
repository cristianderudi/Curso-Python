...
tipo_encuadernacion = input("Ingrese el tipo de encuadernación (rústica o especial): ")
costo = COSTO_BASICO + (COSTO_POR_PAGINA * num_paginas)

# Escriba lo que falta de la solución aquí
if tipo_encuadernacion.lower() == "rústica":
    costo += COSTO_ENC_RUSTICA
elif tipo_encuadernacion.lower() == "especial":
