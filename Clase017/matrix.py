...
def crear_matriz(filas:int=3,columnas:int=3,
                 desde:int=0,hasta:int=9)->list[list[int]]:
    if desde > hasta:
...
def buscar(matriz:list[list[int]],numero:int)->tuple:
    filas = len(matriz)
