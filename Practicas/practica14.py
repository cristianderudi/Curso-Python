...
El programa debe calcular y mostrar el valor total del terreno. Además, debe calcular la cantidad de metros de alambre necesarios para cercar completamente el terreno a tres alturas distintas.
...
largo = int(input("Ingrese largo del terreno: "))
valor_metro = float(input("Ingrese valor metro cuadrado: "))

# Calcular valor total del terreno.
total = ancho * largo * valor_metro
print(f"Valor total del terreno: $ {total}")

# Calcular cantidad de alambre necesaria para cercar el terreno a distintas alturas.
perimetro = ancho * 2 + largo * 2
for i in range (1, 4):
    cantidad_alambre = perimetro * i
    print(f"Cantidad de alambre para {i} metro(s) de altura: {cantidad_alambre} metros")
