...
angulo1= int(input("Ingrese primer valor: "))
angulo2= int(input("Ingrese segundo valor: "))

resto = 180 - (angulo1 + angulo2)
if angulo1 < 0 or angulo2 < 0 or resto < 0:
    print(f"El valor ingresado es invalido")
else:
    print(f"El angulo restante es de: {resto} grados")
